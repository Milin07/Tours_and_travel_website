...
<body>
    ...
    <section class="packages">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <div class="image">
                    <img src="img/changlang.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Changlang</h3>
                    ...
                    <a href="#" class="btn" data-price="16000">add to cart</a>
                </div>
            </div>

            <div class="box">
                <div class="image">
                    <img src="img/namsai.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Namsai</h3>
                     <p class="price">Rs. 11500</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                        quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                        ...
                        proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <a href="book.php" class="btn">Book now</a>
                    <a href="#" class="btn" data-price="11500">add to cart</a>
                </div>
            </div>

            <div class="box">
                <div class="image">
                    <img src="img/ROING.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Roing</h3>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                        ...
                        proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <a href="book.php" class="btn">Book now</a>
                    <a href="#" class="btn" data-price="11000">add to cart</a>
                </div>
            </div>
        </div>
